...
/**
 * SPI for properties providers which configure a resource using the configuration provided by the {@link ServiceInfo} object
 *
 * @see ServiceInfo
 */
public interface PropertiesProvider {
    ...
    /**
     * Check if this {@link PropertiesProvider} instance can configure the TomEE resource associated with the provided {@link ServiceInfo}
     *
     * @param serviceInfo <code>ServiceInfo</code> instance containing configuration information for a bound service
     * @return <code>true</code> if this  <code>PropertiesProvider</code> instance can configure the TomEE resource associate with the provided <code>ServiceInfo</code>
     * @see ServiceInfo
     */
