...
public class DelegatingPropertiesProviderTest {
    ...
    public void testProvideJdbcProperties() throws Exception {
        configureDelegatingPropertiesProvider(DEFAULT_CONTEXT_ROOT + "/" + DelegatingPropertiesProvider.PREFIX_JDBC
            + JdbcServiceInfo.ID, new Properties());
    ...
    public void testProvide() throws Exception {
        configureDelegatingPropertiesProvider(DEFAULT_CONTEXT_ROOT + "/" + DummyServiceInfo.class.getName(),
            new Properties());
        Properties properties = propertiesProvider.provides();
